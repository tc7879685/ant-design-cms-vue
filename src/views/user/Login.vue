      ...
      <a-tabs
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
          <a-form-item>
            <a-input
              size="large"
              v-decorator="['corpCode',validatorRules.corpCode,{ validator: this.handleUsernameOrEmail }]"
              type="text"
              placeholder="请输入机构编号/cbc_1000">
          ...
          <a-form-item>
            <a-input
              size="large"
              v-decorator="['userCode',validatorRules.userCode,{ validator: this.handleUsernameOrEmail }]"
              type="text"
          ...
          <a-form-item>
            <a-input
              v-decorator="['userPassword',validatorRules.userPassword]"
              size="large"
              type="password"
              autocomplete="false"
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
          corpCode:{rules: [{ required: true, message: '请输入用户名!',validator: 'click'}]},
          userCode:{rules: [{ required: true, message: '请输入用户名!',validator: 'click'}]},
          userPassword:{rules: [{ required: true, message: '请输入密码!',validator: 'click'}]},
    ...
    methods: {
      ...
      handleSubmit () {
        ...
        if (that.customActiveKey === 'tab1') {
          that.form.validateFields([ 'userCode', 'userPassword','corpCode' ], { force: true }, (err, values) => {
            if (!err) {
              loginParams.corpCode = values.corpCode
